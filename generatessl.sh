...
CONTINUE="n/a"
printf "  This script will create/modify the folder $LOCAL_CERT_PATH\n"
printf "  This script will alert you when it must run in sudo mode\n"
printf ""
while [[ ! "$CONTINUE" =~ ^[yYnN]$ ]]
...
printf '\n';
CONTINUE="n/a"
printf "  The following command requires sudo privileges\n"
while [[ ! "$CONTINUE" =~ ^[yYnN]$ ]]
...
printf '  Creating server.csr.cnf... '
